...
#define COLOR_COMMAND 4
#define COLOR_RESPONSE 5
#define POLL 0
#define POLL_ACK 1
#define RANGE 2
...
//  Serial.print("Transmitting packet ... #");
  ...
  char color_data[5] = {COLOR_RESPONSE, rgb.red, rgb.green, rgb.blue, rgb.white};
  DW1000.setData(color_data, 5);
...
void loop() {
    ...
    if (expectedMsgId == ANY) {
      if(Serial.available()){
        String s = Serial.readString();
        char comma[2] = ",";
        
        str = s.c_str();
        rgb.red = atoi(strtok(str,comma));      
        rgb.green = atoi(strtok(NULL, comma));
        rgb.blue = atoi(strtok(NULL, comma));
        rgb.white = atoi(strtok(NULL, comma));
